...
;MyProject.c,196 :: 		[2] && code1[3] == user1[3] && code1[4] == 35) //compare code with store one
	...
	GOTO       L_main54
L__main83:
;MyProject.c,198 :: 		Lcd_Cmd(_LCD_CLEAR);   // Clear display
	MOVLW      1
	MOVWF      FARG_Lcd_Cmd_out_char+0
	CALL       _Lcd_Cmd+0
;MyProject.c,199 :: 		Lcd_Out(1, 2, msg3);
	MOVLW      1
	MOVWF      FARG_Lcd_Out_row+0
	MOVLW      2
	MOVWF      FARG_Lcd_Out_column+0
	...
	MOVWF      FARG_Lcd_Out_text+0
	CALL       _Lcd_Out+0
;MyProject.c,200 :: 		Lcd_Out(2, 2, msg7);
	MOVLW      2
	MOVWF      FARG_Lcd_Out_row+0
	MOVLW      2
	MOVWF      FARG_Lcd_Out_column+0
	...
	MOVWF      FARG_Lcd_Out_text+0
	CALL       _Lcd_Out+0
;MyProject.c,201 :: 		cnt=0;
	CLRF       _cnt+0
	CLRF       _cnt+1
;MyProject.c,202 :: 		PORTA.B0=0;
	BCF        PORTA+0, 0
;MyProject.c,203 :: 		PORTA.B2=1;           //Buzzer
	BSF        PORTA+0, 2
;MyProject.c,204 :: 		Delay_ms(3000);
	MOVLW      16
	MOVWF      R11+0
	MOVLW      57
	MOVWF      R12+0
...
;MyProject.c,205 :: 		Lcd_Cmd(_LCD_CLEAR);
	...
	MOVWF      FARG_Lcd_Cmd_out_char+0
	CALL       _Lcd_Cmd+0
;MyProject.c,206 :: 		Lcd_Out(2, 2, msg7);
	MOVLW      2
	MOVWF      FARG_Lcd_Out_row+0
	MOVLW      2
	MOVWF      FARG_Lcd_Out_column+0
	...
	MOVWF      FARG_Lcd_Out_text+0
	CALL       _Lcd_Out+0
;MyProject.c,208 :: 		for(i=0; i<3; i++) {               // Move text to the right 4 times
	CLRF       _i+0
	CLRF       _i+1
L_main56:
	MOVLW      128
...
L__main94:
	BTFSC      STATUS+0, 0
	GOTO       L_main57
;MyProject.c,209 :: 		Lcd_Cmd(_LCD_SHIFT_RIGHT);
	MOVLW      28
	MOVWF      FARG_Lcd_Cmd_out_char+0
	CALL       _Lcd_Cmd+0
;MyProject.c,210 :: 		Move_Delay();}
	CALL       _Move_Delay+0
;MyProject.c,208 :: 		for(i=0; i<3; i++) {               // Move text to the right 4 times
	INCF       _i+0, 1
	BTFSC      STATUS+0, 2
...
L_main59:
	...
	NOP
	NOP
;MyProject.c,212 :: 		for(i=0; i<5; i++) {               // Move text to the right 4 times
	CLRF       _i+0
	CLRF       _i+1
L_main60:
	MOVLW      128
...
L__main95:
	BTFSC      STATUS+0, 0
	GOTO       L_main61
;MyProject.c,213 :: 		Lcd_Cmd(_LCD_SHIFT_LEFT);
	MOVLW      24
	MOVWF      FARG_Lcd_Cmd_out_char+0
	CALL       _Lcd_Cmd+0
;MyProject.c,214 :: 		Move_Delay();}
	CALL       _Move_Delay+0
;MyProject.c,212 :: 		for(i=0; i<5; i++) {               // Move text to the right 4 times
	INCF       _i+0, 1
	BTFSC      STATUS+0, 2
...
L_main63:
	...
	NOP
	NOP
;MyProject.c,216 :: 		for(i=0; i<2; i++) {               // Move text to the right 4 times
	CLRF       _i+0
	CLRF       _i+1
L_main64:
	MOVLW      128
...
L__main96:
	BTFSC      STATUS+0, 0
	GOTO       L_main65
;MyProject.c,217 :: 		Lcd_Cmd(_LCD_SHIFT_RIGHT);
	MOVLW      28
	MOVWF      FARG_Lcd_Cmd_out_char+0
	CALL       _Lcd_Cmd+0
;MyProject.c,218 :: 		Move_Delay();}
	CALL       _Move_Delay+0
;MyProject.c,216 :: 		for(i=0; i<2; i++) {               // Move text to the right 4 times
	INCF       _i+0, 1
	BTFSC      STATUS+0, 2
...
L_main67:
	...
	NOP
	NOP
;MyProject.c,220 :: 		Delay_ms(1000);    // Lock reactivate Time
	MOVLW      6
	MOVWF      R11+0
	MOVLW      19
	MOVWF      R12+0
...
L_main68:
	...
	NOP
	NOP
;MyProject.c,221 :: 		PORTA.B2=0;
	BCF        PORTA+0, 2
;MyProject.c,222 :: 		cnt=0;
	CLRF       _cnt+0
	CLRF       _cnt+1
...
L_main69:
	...
	NOP
	NOP
;MyProject.c,225 :: 		Lcd_Out(1,2,msg1);
	MOVLW      1
	MOVWF      FARG_Lcd_Out_row+0
	MOVLW      2
	MOVWF      FARG_Lcd_Out_column+0
