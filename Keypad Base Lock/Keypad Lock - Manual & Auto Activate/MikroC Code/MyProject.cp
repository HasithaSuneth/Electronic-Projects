#line 1 "E:/Hasitha Suneth/Hasitha/Electronics/Electronic Projects & Circuit Diagrams/PIC Base Keypad Locks/Keypad Lock 5/Manual & Auto activate Keypad Lock/Keypad Codes (Manual Reactivate)/MyProject.c"
#line 5 "E:/Hasitha Suneth/Hasitha/Electronics/Electronic Projects & Circuit Diagrams/PIC Base Keypad Locks/Keypad Lock 5/Manual & Auto activate Keypad Lock/Keypad Codes (Manual Reactivate)/MyProject.c"
unsigned short kp;
char code1[10] ,user1[4];
char msg1[20] = ".. PROTECTED ..",msg2[12] = "ENTER CODE";
char msg3[] = "ACCESS GRANETED",msg4[15] = "ACCESS DENIED";
char msg5[15] = "Enter New Code",msg6[] = " By HASITHA " ;
